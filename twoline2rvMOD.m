...
%  ----------------------------------------------------------------------------*/
function [satrec, startmfe, stopmfe, deltamin] = twoline2rvMOD(longstr1,longstr2)
%        [satrec, startmfe, stopmfe, deltamin] = twoline2rv(longstr1,longstr2)

%function [satrec, startmfe, stopmfe, deltamin] = twoline2rv(whichconst, longstr1, ...
%          longstr2, typerun,typeinput)   %CLRmod

global tumin radiusearthkm xke j2 j3 j4 j3oj2

whichconst=84; %WGS84  CLRmod


% typeinput=input('\n \n Choose type of simulation time input: \n, ''a'' - automatic input, \n, ''m'' - manual(year - day - month - minute - second), \n, ''mc'' - manual(year - day of year). \n  Default: [''a''] \n \n');     %       CLRmod
